class Spellcaster < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    url "https://github.com/MakinaHQ/makina-rs/releases/download/spellcaster-v0.5.7/spellcaster-aarch64-apple-darwin.tar.xz"
    sha256 "1e2f39865f7a46f356ae352a0c56a236f5afe072f20711efec7a3e77fec22571"
  end
  if OS.linux?
    if Hardware::CPU.arm?
      url "https://github.com/MakinaHQ/makina-rs/releases/download/spellcaster-v0.5.7/spellcaster-aarch64-unknown-linux-gnu.tar.xz"
      sha256 "a3704a47934048bfc34108dfba5274c9abdd723d3b88338c878ef34033da14ba"
    end
    if Hardware::CPU.intel?
      url "https://github.com/MakinaHQ/makina-rs/releases/download/spellcaster-v0.5.7/spellcaster-x86_64-unknown-linux-gnu.tar.xz"
