class Spellcaster < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
      url "https://github.com/MakinaHQ/spellcaster-releases/releases/download/spellcaster-v0.5.4/spellcaster-aarch64-apple-darwin.tar.xz"
      sha256 "deb4b33cf9dca20de8393d6d4abf31d8c0b89dff6c7b7976902f92be5e4f493a"
  end
  if OS.linux?
    if Hardware::CPU.arm?
      url "https://github.com/MakinaHQ/spellcaster-releases/releases/download/spellcaster-v0.5.4/spellcaster-aarch64-unknown-linux-gnu.tar.xz"
      sha256 "a9f9c101944f587327763f7ea97cff387d6818267d211ac7c4815d9b0097c87b"
    end
    if Hardware::CPU.intel?
      url "https://github.com/MakinaHQ/spellcaster-releases/releases/download/spellcaster-v0.5.4/spellcaster-x86_64-unknown-linux-gnu.tar.xz"
