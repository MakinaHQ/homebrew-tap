class Spellcaster < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
      url "https://github.com/MakinaHQ/makina-rs/releases/download/spellcaster-v0.4.3/spellcaster-aarch64-apple-darwin.tar.xz"
      sha256 "780b973a4942949418beab21c308116af89bad3346a01f0d6a72d4817114b02e"
  end
  if OS.linux?
    if Hardware::CPU.arm?
      url "https://github.com/MakinaHQ/makina-rs/releases/download/spellcaster-v0.4.3/spellcaster-aarch64-unknown-linux-gnu.tar.xz"
      sha256 "28f09074c30aa965bd4d01fcc6ba73d3d0cda9fc65a1937fae830fdee4617d92"
    end
    if Hardware::CPU.intel?
      url "https://github.com/MakinaHQ/makina-rs/releases/download/spellcaster-v0.4.3/spellcaster-x86_64-unknown-linux-gnu.tar.xz"
