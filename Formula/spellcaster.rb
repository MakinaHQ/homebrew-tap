class Spellcaster < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
      url "https://github.com/MakinaHQ/spellcaster-releases/releases/download/spellcaster-v0.4.2/spellcaster-aarch64-apple-darwin.tar.xz"
      sha256 "3c63bc64a72853c49ced80957dd734fa32a5e3536d2d73a4bcfc1deeaeda5767"
  end
  if OS.linux?
    if Hardware::CPU.arm?
      url "https://github.com/MakinaHQ/spellcaster-releases/releases/download/spellcaster-v0.4.2/spellcaster-aarch64-unknown-linux-gnu.tar.xz"
      sha256 "0d32a2328d5fa7213d1c195535206bcb2a7800fbd525074005cfb803f3cca53f"
    end
    if Hardware::CPU.intel?
      url "https://github.com/MakinaHQ/spellcaster-releases/releases/download/spellcaster-v0.4.2/spellcaster-x86_64-unknown-linux-gnu.tar.xz"
