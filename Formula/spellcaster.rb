class Spellcaster < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
      url "https://github.com/MakinaHQ/spellcaster-releases/releases/download/spellcaster-v0.5.2/spellcaster-aarch64-apple-darwin.tar.xz"
      sha256 "8f8031a5b6bb6917a1a436b3b523b84808f9c024c1ac646931920ed8dcbd9f15"
  end
  if OS.linux?
    if Hardware::CPU.arm?
      url "https://github.com/MakinaHQ/spellcaster-releases/releases/download/spellcaster-v0.5.2/spellcaster-aarch64-unknown-linux-gnu.tar.xz"
      sha256 "710361dbc201aeaba4afcbbe6e1541920afcfb0220da6fd2c5dc8850589d6228"
    end
    if Hardware::CPU.intel?
      url "https://github.com/MakinaHQ/spellcaster-releases/releases/download/spellcaster-v0.5.2/spellcaster-x86_64-unknown-linux-gnu.tar.xz"
